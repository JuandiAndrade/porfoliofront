          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/in/juan-diego-andrade-polimeni-1a4501249/"><img src={navIcon1} alt="" /></a>
                {/* <a href="#"><img src={navIcon3} alt="" /></a> */}
                <a href="https://github.com/JuandiAndrade"><img src={github2} alt="" /></a>
              </div>
              <HashLink to='#connect'>
